        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="card card-widget">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <img class="img-fluid pad" src="../public/dist/img/photo2.png" alt="Photo">
              ...
              <div class="card-footer card-comments">
                <div class="card-comment">
                  <!-- User image -->
                  <img class="img-circle img-sm" src="../public/dist/img/user3-128x128.jpg" alt="User Image">
                ...
                <div class="card-comment">
                  <!-- User image -->
                  <img class="img-circle img-sm" src="../public/dist/img/user4-128x128.jpg" alt="User Image">
              ...
              <div class="card-footer">
                <form action="#" method="post">
                  <img class="img-fluid img-circle img-sm" src="../public/dist/img/user4-128x128.jpg" alt="Alt Text">
            ...
            <div class="card card-widget">
              ...
              <div class="card-body">
                ...
                <div class="attachment-block clearfix">
                  <img class="attachment-img" src="../public/dist/img/photo1.png" alt="Attachment Image">
              ...
              <div class="card-footer card-comments">
                ...
                <div class="card-comment">
                  <!-- User image -->
                  <img class="img-circle img-sm" src="../public/dist/img/user5-128x128.jpg" alt="User Image">
            ...
            <div class="row">
              <div class="col-md-12 col-lg-6 col-xl-4">
                <div class="card mb-2 bg-gradient-dark">
                  <img class="card-img-top" src="../public/dist/img/photo1.png" alt="Dist Photo 1">
              ...
              <div class="col-md-12 col-lg-6 col-xl-4">
                <div class="card mb-2">
                  <img class="card-img-top" src="../public/dist/img/photo2.png" alt="Dist Photo 2">
              ...
              <div class="col-md-12 col-lg-6 col-xl-4">
                <div class="card mb-2">
                  <img class="card-img-top" src="../public/dist/img/photo3.jpg" alt="Dist Photo 3">
